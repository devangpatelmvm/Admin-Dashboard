      ...
      content: [
        {
          type: "text",
          text:
            "The content of the code editor is kept in sync with the content of the code block in the rich text editor, so that it is as if youre directly editing the outer document, using a more convenient interface."
        }
      ]
    },
    {
